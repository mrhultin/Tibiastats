<div class="ui segment">
    <?php
    echo '<h3>'.$name.' '.$skill.' overview</h3>';
    echo '<p>'.$name.' is an '.$type.' server located in '.$location.'.<br>Experience was last updated '.$expupdated.' and skills were last updated '.$updated.'</p>';
    ?>
